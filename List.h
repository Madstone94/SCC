...
void insertBefore(List L, Node N, int data); // Insert a new Node into Node Nbs list
...
void insertAfter(List L, Node N, int data); // Insert a new Node into Node Nbs list
...
// Node N link to the Node thatbs after Node N as its
// next Node, and making the Node after Node N link to
// the Node thatbs before Node N as its previous Node.
//
